...
first downloaded homebrew
made sure sox is installed inside
cd to pathway (cd Desktop)
sox ciphered.wav ciphered.dat to turn .wav files to .dat files
after running the code and getting the reversed files, used sox ciphered.dat cipheredReverse.wav to get the sound files
